...
def check_img(img_path):
    ...
    w_h = img_width/img_height
    if file_size < 30 * 1024 or file_size > 250 * 1024 or w_h>1.8:
        return False
    if img_width > 4000 or img_width < 200 or img_height < 200 or img_height > 3000:
        return False
    ...
    if img_gradient < 20 or img_gradient > 220:
        return False
...
if __name__ == '__main__':
    root_dir = "/home/katrina/Documents/deepshare_project/flower/cls_06/cls_06/code/Image-Downloader-master/download_images/face_"
